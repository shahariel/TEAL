"""
This code is based on the code from Avalanche library https://github.com/ContinualAI/avalanche
"""
...
from avalanche.benchmarks.utils import (
    ...
    AvalancheDataset, make_avalanche_dataset, FlatData,
)
...
class ParametricBuffer(BalancedExemplarsBuffer):
    ...
    def __init__(
            ...
            max_size: int,
            groupby=None,
            selection_strategy=None,  # Optional["ExemplarsSelectionStrategy"]
    ):
        """Init.
...
class _ParametricSingleBuffer(ExemplarsBuffer):
    ...
    def update_from_dataset(self, strategy, new_data):
        self.buffer = new_data if len(self.buffer) == 0 else self.buffer.concat(new_data)
