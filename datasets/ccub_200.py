...
_default_train_transform = transforms.Compose(
    [
        ...
        transforms.ToTensor(),
        transforms.Normalize((0.4856, 0.4994, 0.4324), (0.2272, 0.2226, 0.2613))
    ]
)
#     [
#         transforms.RandomHorizontalFlip(),
...
def _get_cub200_dataset(root):
    train_set = CUB200(root, train=True)  # , transform=_default_train_transform
    test_set = CUB200(root, train=False)  # , transform=_default_eval_transform
